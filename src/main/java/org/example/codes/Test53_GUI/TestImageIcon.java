package org.example.codes.Test53_GUI;//Bu programda resim dosyalarından ikon üretiliyor. Resimler belirtilen klasörde bulunmalı (Bu program için projenin klasöründe bir alt klasör olan resim klasöründe kayıtlı olmalı.)
import javax.swing.*;
import java.awt.*;
